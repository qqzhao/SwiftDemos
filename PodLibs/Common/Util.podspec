...
Pod::Spec.new do |s|
  ...
  #   * Finally, don't worry about the indent, CocoaPods strips it!/Volumes/QQDisk/Private/GitHub/SwiftDemos/PodLibs/QQSDK/QQSDK.podspec
  #s.description  = <<-DESC
  #                 DESC
  ...
  # Or just: s.author    = "qqzhao2010@gmail.com"
  # s.authors            = { "qqzhao2010@gmail.com" => "qqzhao2010@gmail.com" }
  # s.social_media_url   = "http://twitter.com/qqzhao2010@gmail.com"
  ...
  s.source_files  = "Util/Classes", "*.{swift}"
  s.exclude_files = "Util/Exclude"
